                ...
                maxThreadCount:(int)maxThreadCount
{
    ...
    if (self) {
        ...
        _metalLibrary = [device newDefaultLibraryWithBundle:SWIFTPM_MODULE_BUNDLE
                                                      error:&libError];
        NSAssert(_metalLibrary != nil, @"Failed to load StandardCyborgFusion Metal library: %@", libError);
